...
# 44 "/usr/include/c++/4.4.6/cstddef" 2 3
# 1 "/opt/software/ClusterStudio/2013.1/composer_xe_2013.1.117/composer_xe_2013.1.117/compiler/include/stddef.h" 1 3
...
# 45 "/usr/include/c++/4.4.6/ctime" 2 3
...
void ForceEAM::read_file(const char* filename)
{
  ...
  MPI_Bcast(&flag, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  ...
  MPI_Bcast(&file->mass, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  MPI_Bcast(&file->nrho, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  MPI_Bcast(&file->drho, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  MPI_Bcast(&file->nr, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  MPI_Bcast(&file->dr, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  MPI_Bcast(&file->cut, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  mass = file->mass;
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Bcast(file->frho, file->nrho, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  else
    MPI_Bcast(file->frho, file->nrho, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));

  if(me == 0) grab(fptr, file->nr, file->zr);

  if(sizeof(MMD_float) == 4)
    MPI_Bcast(file->zr, file->nr, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  else
    MPI_Bcast(file->zr, file->nr, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));

  if(me == 0) grab(fptr, file->nr, file->rhor);

  if(sizeof(MMD_float) == 4)
    MPI_Bcast(file->rhor, file->nr, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  else
    MPI_Bcast(file->rhor, file->nr, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
...
void ForceEAM::communicate(Atom &atom, Comm &comm)
{
  ...
  for(iswap = 0; iswap < comm.nswap; iswap++) {
    ...
    if(comm.sendproc[iswap] != me) {
      if(sizeof(MMD_float) == 4) {
        MPI_Irecv(comm.buf_recv, comm.comm_recv_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_float))),
                  comm.recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
        MPI_Send(comm.buf_send, comm.comm_send_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_float))),
                 comm.sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
      } else {
        MPI_Irecv(comm.buf_recv, comm.comm_recv_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_double))),
                  comm.recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
        MPI_Send(comm.buf_send, comm.comm_send_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_double))),
                 comm.sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
      }
