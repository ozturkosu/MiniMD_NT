...
class ForceLJ : Force
{
  ...
  protected:
    template<int EVFLAG>
    void compute_NT1(Atom &, Neighbor &, int);
    template<int EVFLAG>
    void compute_NT2(Atom &, Neighbor &, int);
    template<int EVFLAG>
    void compute_NT3(Atom &, Neighbor &, int);
    template<int EVFLAG>
    void compute_NT4(Atom &, Neighbor &, int);
    template<int EVFLAG>
    void compute_NT5(Atom &, Neighbor &, int);
    template<int EVFLAG>
...
void Thermo::compute(MMD_int iflag, Atom &atom, Neighbor &neighbor, Force* force, Timer &timer, Comm &comm)
{
  ...
  #pragma omp master
  {
    ...
    if(threads->mpi_me == 0) {
      fprintf(stdout, "istep: %i temp: %e energy: %e pressure: %e %6.3lf\n", istep, t, eng, p, istep == 0 ? 0.0 : timer.array[0]);
    }
...
MMD_float Thermo::energy(Atom &atom, Neighbor &neighbor, Force* force)
{
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Allreduce(&e_act, &eng, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  else
    MPI_Allreduce(&e_act, &eng, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
...
MMD_float Thermo::temperature(Atom &atom)
{
  ...
  {
    if(sizeof(MMD_float) == 4)
      MPI_Allreduce(&t_act, &t1, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
    else
      MPI_Allreduce(&t_act, &t1, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
...
MMD_float Thermo::pressure(MMD_float t, Force* force)
{
  ...
  if(sizeof(MMD_float) == 4)
    MPI_Allreduce(&p_act, &virial, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  else
    MPI_Allreduce(&p_act, &virial, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
