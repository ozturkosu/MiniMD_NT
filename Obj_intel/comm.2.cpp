...
# 1 "/opt/software/ClusterStudio/2013.1/composer_xe_2013.1.117/composer_xe_2013.1.117/compiler/include/omp.h" 1 3
...
# 50 "/opt/software/ClusterStudio/2013.1/composer_xe_2013.1.117/composer_xe_2013.1.117/compiler/include/omp.h" 3


# 62 "/opt/software/ClusterStudio/2013.1/composer_xe_2013.1.117/composer_xe_2013.1.117/compiler/include/omp.h" 3
...
int Comm::setup(MMD_float cutneigh, Atom &atom)
{
  ...
  MPI_Cart_create(((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), 3, procgrid, periods, reorder, &cartesian);
    ...
    if(sendproc[iswap] != me) {
      #pragma omp master
      {
        if(sizeof(MMD_float) == 4) {
          MPI_Irecv(buf_recv, comm_recv_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_float))),
          recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
          MPI_Send(buf_send, comm_send_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_float))),
          sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        } else {
          MPI_Irecv(buf_recv, comm_recv_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_double))),
          recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
          MPI_Send(buf_send, comm_send_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_double))),
          sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        }
...
void Comm::reverse_communicate(Atom &atom)
{
  ...
  for(iswap = nswap - 1; iswap >= 0; iswap--) {
    ...
    if(sendproc[iswap] != me) {
      ...
      {
        if(sizeof(MMD_float) == 4) {
          MPI_Irecv(buf_recv, reverse_recv_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_float))),
          sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
          MPI_Send(buf_send, reverse_send_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_float))),
          recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        } else {
          MPI_Irecv(buf_recv, reverse_recv_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_double))),
          sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
          MPI_Send(buf_send, reverse_send_size[iswap], ((MPI_Datatype) ((void *) &(ompi_mpi_double))),
          recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        }
        MPI_Wait(&request, &status);
      }
...
void Comm::exchange(Atom &atom)
{
  ...
  for(idim = 0; idim < 3; idim++) {
    ...
    #pragma omp master
    {
      ...
      MPI_Send(&nsend, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), procneigh[idim][0], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
      MPI_Recv(&nrecv1, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), procneigh[idim][1], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &status);
      nrecv = nrecv1;

      if(procgrid[idim] > 2) {
        MPI_Send(&nsend, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), procneigh[idim][1], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        MPI_Recv(&nrecv2, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), procneigh[idim][0], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &status);
        nrecv += nrecv2;
      }
      ...
      if(sizeof(MMD_float) == 4) {
        MPI_Irecv(buf_recv, nrecv1, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), procneigh[idim][1], 0,
                  ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
        MPI_Send(buf_send, nsend, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), procneigh[idim][0], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
      } else {
        MPI_Irecv(buf_recv, nrecv1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), procneigh[idim][1], 0,
                  ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
        MPI_Send(buf_send, nsend, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), procneigh[idim][0], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
      }
      ...
      if(procgrid[idim] > 2) {
        if(sizeof(MMD_float) == 4) {
          MPI_Irecv(&buf_recv[nrecv1], nrecv2, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), procneigh[idim][0], 0,
                    ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
          MPI_Send(buf_send, nsend, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), procneigh[idim][1], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        } else {
          MPI_Irecv(&buf_recv[nrecv1], nrecv2, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), procneigh[idim][0], 0,
                    ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
          MPI_Send(buf_send, nsend, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), procneigh[idim][1], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        }
  ...
  for(idim = 0; idim < 3; idim++) {
    ...
    for(int ineed = 0; ineed < 2 * need[idim]; ineed += 1) {
      if(ineed < procgrid[idim] - 1) {
        MPI_Send(&nsend, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), sendproc_exc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        MPI_Recv(&nrecv, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), recvproc_exc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &status);

        if(nrecv > maxrecv) growrecv(nrecv);

        if(sizeof(MMD_float) == 4) {
          MPI_Irecv(buf_recv, nrecv, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), recvproc_exc[iswap], 0,
                    ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
          MPI_Send(buf_send, nsend, ((MPI_Datatype) ((void *) &(ompi_mpi_float))), sendproc_exc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        } else {
          MPI_Irecv(buf_recv, nrecv, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), recvproc_exc[iswap], 0,
                    ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
          MPI_Send(buf_send, nsend, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), sendproc_exc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
        }
  ...
  for(idim = 0; idim < 3; idim++) {
    ...
    for(ineed = 0; ineed < 2 * need[idim]; ineed++) {
      ...
      #pragma omp master
      {
        ...
        if(sendproc[iswap] != me) {
          MPI_Send(&nsend, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
          MPI_Recv(&nrecv, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &status);

          if(nrecv * atom.border_size > maxrecv) growrecv(nrecv * atom.border_size);

          if(sizeof(MMD_float) == 4) {
            MPI_Irecv(buf_recv, nrecv * atom.border_size, ((MPI_Datatype) ((void *) &(ompi_mpi_float))),
                      recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
            MPI_Send(buf_send, nsend * atom.border_size, ((MPI_Datatype) ((void *) &(ompi_mpi_float))),
                     sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
          } else {
            MPI_Irecv(buf_recv, nrecv * atom.border_size, ((MPI_Datatype) ((void *) &(ompi_mpi_double))),
                      recvproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))), &request);
            MPI_Send(buf_send, nsend * atom.border_size, ((MPI_Datatype) ((void *) &(ompi_mpi_double))),
                     sendproc[iswap], 0, ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
          }
