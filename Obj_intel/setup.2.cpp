...
# 1 "/usr/include/c++/4.4.6/cstdio" 1 3
...
# 40 "/usr/include/c++/4.4.6/x86_64-redhat-linux/bits/os_defines.h" 2 3
...
# 44 "/usr/include/c++/4.4.6/cstdio" 2 3
...
# 45 "/usr/include/c++/4.4.6/cstdio" 2 3
...
# 46 "/usr/include/c++/4.4.6/cstdio" 2 3





# 92 "/usr/include/c++/4.4.6/cstdio" 3
...
# 163 "/usr/include/c++/4.4.6/cstdio" 3
...
# 204 "/usr/include/c++/4.4.6/cstdio" 3

# 33 "setup.cpp" 2
# 1 "/usr/include/c++/4.4.6/cmath" 1 3
...
# 45 "/usr/include/c++/4.4.6/cmath" 2 3
...
# 46 "/usr/include/c++/4.4.6/cmath" 2 3
...
# 47 "/usr/include/c++/4.4.6/cmath" 2 3





# 76 "/usr/include/c++/4.4.6/cmath" 3
...
# 491 "/usr/include/c++/4.4.6/cmath" 3
...
# 1 "/usr/include/c++/4.4.6/bits/cmath.tcc" 1 3
...
# 610 "/usr/include/c++/4.4.6/cmath" 2 3


# 630 "/usr/include/c++/4.4.6/cmath" 3
...
# 1 "/usr/include/c++/4.4.6/cstring" 1 3
...
# 45 "/usr/include/c++/4.4.6/cstring" 2 3
...
# 73 "/usr/include/c++/4.4.6/cstring" 3
...
# 120 "/usr/include/c++/4.4.6/cstring" 3
...
void read_lammps_parse_keyword(int first)
{
  ...
  if(!first) {
    if(fgets(line, 255, fp) == __null) eof = 1;
  }
  ...
  if(fgets(buffer, 255, fp) == __null) eof = 1;
...
void read_lammps_header(Atom &atom)
{
  ...
  while(1) {
    ...
    if(fgets(line, 255, fp) == __null) n = 0;
...
int create_atoms(Atom &atom, int nx, int ny, int nz, double rho)
{
  ...
  int iflagall;
  MPI_Allreduce(&iflag, &iflagall, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_int))), ((MPI_Op) ((void *) &(ompi_mpi_op_max))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
...
void create_velocity(double t_request, Atom &atom, Thermo &thermo)
{
  ...
  double tmp;
  MPI_Allreduce(&vxtot, &tmp, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  vxtot = tmp / atom.natoms;
  MPI_Allreduce(&vytot, &tmp, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
  vytot = tmp / atom.natoms;
  MPI_Allreduce(&vztot, &tmp, 1, ((MPI_Datatype) ((void *) &(ompi_mpi_double))), ((MPI_Op) ((void *) &(ompi_mpi_op_sum))), ((MPI_Comm) ((void *) &(ompi_mpi_comm_world))));
