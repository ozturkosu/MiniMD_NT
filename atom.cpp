...
//    destroy_2d_MMD_float_array(tempf); //mathi
...
void Atom::growarray()
{
  ...
  //tempf = (MMD_float**) realloc_2d_MMD_float_array(f, nmax, PAD, PAD * nold); //mathi
  xold = (MMD_float**) realloc_2d_MMD_float_array(xold, nmax, PAD, PAD * nold);

  if(x == NULL || v == NULL || f == NULL || xold == NULL) { //|| tempf == NULL) {
